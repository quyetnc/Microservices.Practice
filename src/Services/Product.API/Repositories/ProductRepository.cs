...
namespace Product.API.Repositories
{
    public class ProductRepository : RepositoryBase<CatalogProduct, long, ProductContext>, IProductRepository
    {
        ...
        public Task<CatalogProduct> GetProductByNo ( string productNo ) => FindByCondition(x => x.No.Equals(productNo)).FirstOrDefaultAsync();
        ...
        Task<List<long>> IRepositoryBaseAsync<CatalogProduct, long, ProductContext>.CreateListAsync ( IEnumerable<CatalogProduct> entities )
        {
